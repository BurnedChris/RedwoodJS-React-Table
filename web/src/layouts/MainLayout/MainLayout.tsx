  ...
  return (
    <>
      ...
      <div className="min-h-full">
        <div className="bg-nord-0 pb-32">
          <Disclosure as="nav" className="bg-nord-0">
            {({ open }) => (
              <>
                    ...
                    <div className="flex items-center justify-between h-16 px-4 sm:px-0">
                      <div className="flex items-center">
                        <div className="flex-shrink-0 text-white">
                          Redwood + React Query + React Table
                        </div>
                      </div>
                      ...
                      <div className="-mr-2 flex md:hidden">
                        {/* Mobile menu button */}
                        <button className="bg-nord-0 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                          <span className="sr-only">Open Github</span>
        ...
        <main className="-mt-24">
          <div className="max-w-[100rem] mx-auto pb-12 px-4 sm:px-6 lg:px-8">
            {children}
          </div>
        </main>
      </div>
